...
- Fix mutation logic for `giantswarm.io/cluster` label for org-namespaced App CRs.
...
[Unreleased]: https://github.com/giantswarm/app-admission-controller/compare/v0.16.0...HEAD
