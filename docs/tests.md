...
In general when the admission controller receives an admission request it will be send to the right admission handler depending on the [webhook configuration](../helm/app-admission-controller/templates/webhook.yaml).
...
import (
	...
	"github.com/giantswarm/app-admission-controller/pkg/admission"
	"github.com/giantswarm/app-admission-controller/pkg/testrunner"
